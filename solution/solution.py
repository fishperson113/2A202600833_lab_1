...
def call_openai(
    ...
    latency = max(time.perf_counter() - start_time, 1e-9)
...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_estimated_tokens = len(gpt4o_response.split()) / 0.75
    gpt4o_cost_estimate = (
        gpt4o_estimated_tokens / 1000
...
# Ensure the module has a valid importable name for unittest.mock.patch targets.
